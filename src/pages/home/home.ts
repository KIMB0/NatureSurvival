...
export class HomePage {
  ...
  ionViewDidLoad(){
    ...
    [new GuideItem("Water","About water","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to find water","Proin lectus justo, quam vehicula ultrices.","assets/img/food/water1.jpg"), new GuideItem("Water filter","About water filter","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to make water filter","Proin lectus justo, quam vehicula ultrices.","assets/img/drinks/water1.jpg"), new GuideItem("Water filter 2","About water filter","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to make water filter","Proin lectus justo, quam vehicula ultrices.","assets/img/drinks/water2.jpg")]))

    this.survivalList.push(new Guide("Tools","How to make tools", "assets/img/tool.png",
    [new GuideItem("Fire","About fire","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to make fire","Proin lectus justo, quam vehicula ultrices.","assets/img/food/fire1.jpg"), new GuideItem("Stone knife","About knife","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to make knife","Proin lectus justo, quam vehicula ultrices.","assets/img/tools/knife1.jpg"), new GuideItem("40 knots","About knots","Proin lectus justo, quam vehicula ultrices. In sit augue, nulla luctus, ligula ut feugiat. Morbi ut, lacus fermentum.","How to make knots","Proin lectus justo, quam vehicula ultrices.","assets/img/tools/knot1.jpg")]))
